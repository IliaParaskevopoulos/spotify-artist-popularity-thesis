...
# create final dataset: social_stats -------------------------------------
...
#Exploratory Plots
plot(social_stats$playlist_count,social_stats$playlist_reach,xlab = "Playlist Count", ylab = "Playlist Reach") #Playlist Reach vs Playlist Count
...
#DV- Gender, Press Contact, Booking Agent
...
social_stats$press_contact <- as.integer(social_stats$press_contact)  #it is necessary to run this line to get the sd below
social_stats$booking_agent <- as.integer(social_stats$booking_agent)  #it is necessary to run this line to get the sd below
...
#Popularity Score vs Popularity Metrics Score
par(mfcol=c(2,3))
...
ggplot(social_stats, aes(as.factor(social_stats$country_classified), social_stats$popularity_score)) + 
  geom_boxplot(ylab = "Popularity") #popularity_score per country_classified boxplot
...
summary(linearMod_social_stats) # BENELUX as reference
